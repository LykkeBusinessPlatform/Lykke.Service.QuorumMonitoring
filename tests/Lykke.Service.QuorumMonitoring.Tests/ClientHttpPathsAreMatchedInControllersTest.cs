...
using Lykke.Service.QuorumMonitoring;
using Lykke.Service.QuorumMonitoring.Client;
using Microsoft.AspNetCore.Mvc;
using Refit;
using Xunit;

namespace Lykke.Service.QuorumMonitoring.Tests
{
    public class ClientHttpPathsAreMatchedInControllersTest
    {
        ...
        {
            var clientInterface = typeof(IQuorumMonitoringClient);
