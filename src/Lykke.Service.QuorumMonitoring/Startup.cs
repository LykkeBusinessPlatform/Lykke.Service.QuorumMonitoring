...
namespace Lykke.Service.QuorumMonitoring
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "QuorumMonitoringLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.QuorumMonitoringService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("QuorumMonitoring", channelOptions =>
                        {
